...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = `4102326_cloud_sun_sunny_weather_icon.png`
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = `nd8p959urcghgmtd6j0qbkgcu9-1fa36a6c610f52c2fba74071d24488c1.png`
        ...
        if (weatherMain == 'Drizzle') {
            image.src = `4102318_cloud_heavy rain_rain_storm_thunderbolt_icon.png`
